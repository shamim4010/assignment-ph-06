  ...
  return (
    <div className="navbar shadow-lg px-12">
        <div className="navbar-start">
            ...
            <a className='bg-[linear-gradient(to_right,rgba(79,57,246,1)_0%,rgba(149,20,250,1)_100%)] text-transparent bg-clip-text text-2xl cursor-pointer active:scale-[0.98]'>DigiTools</a>
        </div>
        ...
        <div className="navbar-end flex items-center gap-4">
            <div className="flex-none"> 
                <div className="indicator">
                    ...
                    <span className={`${notify.notifyCount === 0 && 'hidden'} p-2.5 rounded-full bg-red-500 relative right-3 top-[-8px] text-white`}><div className='absolute top-[3.2px] left-[30%] text-xs'>{notify.notifyCount}</div></span>
                </div>
            </div>
