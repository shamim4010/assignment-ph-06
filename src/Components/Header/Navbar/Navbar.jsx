        ...
        <div className="navbar-end flex items-center gap-4">
            <div className="flex-none"> 
                <div className="indicator">
                    ...
                    <span className={`${notify.notify === 0 && 'hidden'} p-2.5 rounded-full bg-red-500 relative right-3 top-[-8px] text-white`}><div className='absolute top-[3.2px] left-[30%] text-xs'>{notify.notify}</div></span>
                </div>
            </div>
